        ...
        <div style={{ overflowY: 'auto', flex: 1, padding: '16px 20px 32px' }}>
          <div style={{ backgroundColor: '#fff', borderRadius: 20, padding: '20px', boxShadow: '0 2px 10px rgba(0,0,0,0.05)' }}>
            ...
            <div>
              ...
              <textarea value={desc} onChange={e => setDesc(e.target.value)} placeholder="어떤 그룹인가요?" rows={4} style={{ width: '100%', border: '1px solid #E5E8EB', borderRadius: 10, padding: '12px 14px', fontSize: 14, color: '#191F28', outline: 'none', resize: 'none', boxSizing: 'border-box', lineHeight: 1.6, fontFamily: 'inherit', backgroundColor: '#DBE9F9' }} />
            </div>
          </div>
